...
Button7 = Button(root, text=7, width=5, height=2, font=('Times New Roman', 16),
				command=lambda: click(text))
Button8 = Button(root, text=8, width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
Button9 = Button(root, text=9, width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
Buttondivide = Button(root, text='/', width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
'''
...
Buttonsin = Button(root, text='sin', width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
Buttoncos = Button(root, text='cos', width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
Buttontan = Button(root, text='tan', width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text)) 
Buttonequal = Button(root, text='=', width=5, height=2, font=('Times New Roman', 16), command=lambda: click(text))
